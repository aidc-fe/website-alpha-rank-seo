...
export default function MarketInsight() {
  return (
    <div className={"flex gap-5 w-[1200px] h-[480px]"}>
      <CommonDisplayCard
        lightBg
        className="w-[386px] relative rounded-3xl shrink-0"
        title={"Insight"}
        desc={
            ...
            <div className="flex justify-between">
              <div className="w-[182px] h-[262px] rounded-lg border border-[#F0F0F0]">
                ...
                <div className="flex flex-col p-3.5 gap-1.5">
                  <div className="text-xs leading-5 px-4 py-2 text-neutral-800 rounded-lg bg-[rgba(111,80,232,0.12)]">Transform</div>
                  <div className="text-xs leading-5 px-4 py-2 text-neutral-800 rounded-lg bg-[rgba(111,80,232,0.12)]">Transform</div>
                  <div className="text-xs leading-5 px-4 py-2 text-neutral-800 rounded-lg bg-[rgba(111,80,232,0.12)]">Transform</div>
                  <div className="text-xs leading-5 px-4 py-2 text-neutral-800 rounded-lg bg-[rgba(111,80,232,0.12)]">Transform</div>
                </div>
